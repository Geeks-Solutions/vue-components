...
describe('QuillEditor Component', () => {
  ...
  describe('Component Initialization', () => {
    ...
    it('creates a style element with correct id and CSS for each font', () => {
      ...
      expect(wrapper.vm.editorOptionsObject.modules.toolbar.container[2][0].font).toEqual([
        'open_sans',
        'roboto',
        'poppins',
      ])
  ...
  describe('Media Content Management', () => {
    ...
    it('Should preserve anchor link of a media when updating one', async () => {
      ...
      wrapper.vm.settings =
        '<p><a href="https://google.com" target="_blank"><img src="https://s3.amazonaws.com/eweevtestbucketprivate/sections%2Fsections_suchi4441851b50aa040d4b297e5e647ef2eaacb65a3eb576a4f51bf73b1a31bc98f11.png" media-id="685d49b710d4b50006a4f4ad" loading="lazy"></a></p>'
...
describe('Quill HTML Module Multi-Instance Tests', () => {
  ...
  it('should store module references on their respective containers', () => {
    ...
    expect(quillInstance1.container.__quill_html_module).not.toBe(
      quillInstance2.container.__quill_html_module
    )
  })
