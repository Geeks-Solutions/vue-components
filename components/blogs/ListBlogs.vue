  ...
  methods: {
    ...
    openCreateBlog() {
      if (this.dashboardInfo.available_articles_creation === 0) {
        ...
        return
      } else if (this.dashboardInfo.limits && this.dashboardInfo.limits.next_article_creation_date && !isNaN(Number(this.dashboardInfo.limits.next_article_creation_date)) && Number(this.dashboardInfo.limits.next_article_creation_date) > new Date().getTime()) {
        this.$toast.show(
          {
